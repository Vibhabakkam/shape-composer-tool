...
const ControlPanel = ({ onAddShape }: ControlPanelProps) => {
  ...
  return (
    <div>
      ...
      <div>
        <label>Color</label>
        <select value={color} onChange={e => setColor(e.target.value as ShapeColor)}>
      ...
      <div>
        <label>Size</label>
        <select value={size} onChange={e => setSize(Number(e.target.value) as ShapeSize)}>
      ...
      <div>
        ...
        <select value={position} onChange={e => setPosition(e.target.value as ShapePosition)}>
      ...
      <button onClick={handleAdd}>+ Add Shape</button>
    </div>
  )
}
